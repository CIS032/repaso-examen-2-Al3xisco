...
public class Graficador {
    ...
    public static void grabar() {
        PrintWriter pw = null;
        try {
            FileWriter fw = new FileWriter("L:\\Documentos\\NetBeansProjects\\RepasoExamenEjer2\\RepasoExamenEjer2\\figuras.csv", true);
    ...
    public static String recargar() {
        ...
        try {
            ...
            FileReader f = new FileReader("L:\\Documentos\\NetBeansProjects\\RepasoExamenEjer2\\RepasoExamenEjer2\\figuras.csv");
